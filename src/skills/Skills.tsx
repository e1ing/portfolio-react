        ...
        <div className={style.skillsBlock}>
            <div className={`${styleContainer.container} ${style.skillsContainer}`}>
                ...
                <div className={style.skills}>
                    ...
                    <Skill title={"Git"} description={"React is the entry point to the React library. If you load React from a tag, these top-level APIs are available on the React global."}/>
                </div>
            </div>
        </div>
